 ...
 * elements:
 * <ul>
 * <li>{@link R.id#guidance_title}</li>
 * <li>{@link R.id#guidance_description}</li>
 * <li>{@link R.id#guidance_breadcrumb}</li>
 * <li>{@link R.id#guidance_icon}</li>
 * </ul><p>
...
public class GuidanceStylist implements FragmentAnimationProvider {
     ...
     * {@link R.layout#lb_guidance}. If overridden, the substituted
