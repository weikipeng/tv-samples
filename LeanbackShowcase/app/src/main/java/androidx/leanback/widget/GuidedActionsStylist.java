 ...
 * <ul>
 * <li>{@link R.id#guidedactions_list}</li>
 * </ul><p>
 ...
 * elements:
 * <ul>
 * <li>{@link R.id#guidedactions_item_content}</li>
 * <li>{@link R.id#guidedactions_item_title}</li>
 * <li>{@link R.id#guidedactions_item_description}</li>
 * <li>{@link R.id#guidedactions_item_icon}</li>
 * <li>{@link R.id#guidedactions_item_checkmark}</li>
 * <li>{@link R.id#guidedactions_item_chevron}</li>
 * </ul><p>
...
public class GuidedActionsStylist implements FragmentAnimationProvider {
     ...
     * returns {@link R.layout#lb_guidedactions} or
     * {@link R.layout#lb_guidedbuttonactions} if
     ...
     * Subclasses may override to provide their own customized layouts. The base implementation
     * returns {@link R.layout#lb_guidedactions_item}. If overridden,
     ...
     * EditText} and implement {@link ImeKeyMonitor},
     ...
     * Subclasses may override to provide their own customized layouts. The base implementation
     * supports:
     * <li>{@link R.layout#lb_guidedactions_item}
     * <li>{{@link R.layout#lb_guidedactions_datepicker_item}. If
