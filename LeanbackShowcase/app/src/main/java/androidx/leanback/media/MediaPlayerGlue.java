...
/**
 * This glue extends the {@link PlaybackControlGlue} with a
 * {@link MediaPlayer} synchronization. It supports 7 actions:
 *
 * <ul>
 * <li>{@link PlaybackControlsRow.FastForwardAction}</li>
 * <li>{@link PlaybackControlsRow.RewindAction}</li>
 * <li>{@link  PlaybackControlsRow.PlayPauseAction}</li>
 * <li>{@link PlaybackControlsRow.RepeatAction}</li>
 * <li>{@link PlaybackControlsRow.ThumbsDownAction}</li>
 * <li>{@link PlaybackControlsRow.ThumbsUpAction}</li>
 * </ul>
 *
 * @hide
...
public class MediaPlayerGlue extends PlaybackControlGlue implements
     ...
     * {@link PlaybackControlsRow.RewindAction}. Thus you
